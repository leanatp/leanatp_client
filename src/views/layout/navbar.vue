  ...
  <nav class="site-navbar" :class="navbarClasses">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">H3C精益自动化测试平台</a>
        <a class="site-navbar__brand-mini" href="javascript:;">LATP</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        mode="horizontal">
        <el-menu-item index="1" @click="$router.push({ name: 'setting' })" style="display:none;">
          <template slot="title">
            <el-badge value="new">
        ...
        <el-menu-item index="2" style="display:none;">
          <el-badge value="hot">
            <a href="//www.h3c.com/" target="_blank">官方社区</a>
          </el-badge>
        </el-menu-item>
        <el-submenu index="3">
          <template slot="title">项目切换</template>
          <el-menu-item index="2-1"><a href="javascript:;" target="_blank">项目一</a></el-menu-item>
          <el-menu-item index="2-2"><a href="javascript:;" target="_blank">项目二</a></el-menu-item>
          <el-menu-item index="2-3"><a href="javascript:;" target="_blank">项目三</a></el-menu-item>
        </el-submenu>
