    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="relUserListHandle(scope.row.projectId, scope.row.projectUuid)">关联用户</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        API.project.list(params).then(({data}) => {
          if (data && data.code === 0) {
